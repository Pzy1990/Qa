...
# MILVUS_PORT = 19530
MILVUS_HOST_LOCAL = os.getenv('MILVUS_HOST_LOCAL', 'milvus-standalone-local')
MILVUS_HOST_ONLINE = os.getenv('MILVUS_HOST_ONLINE', MILVUS_HOST_LOCAL)
MILVUS_PORT = int(os.getenv('MILVUS_PORT', '19530'))
# MILVUS_HOST_LOCAL = GATEWAY_IP
# MILVUS_PORT = 19540
MILVUS_COLLECTION_NAME = 'qanything_collection' + KB_SUFFIX

ES_URL = os.getenv('ES_URL', 'http://es-container-local:9200/')
...
MYSQL_HOST_LOCAL = os.getenv('MYSQL_HOST_LOCAL', 'mysql-container-local')
MYSQL_PORT_LOCAL = int(os.getenv('MYSQL_PORT_LOCAL', '3306'))
...
LOCAL_OCR_SERVICE_URL = "192.168.110.169:7001"
